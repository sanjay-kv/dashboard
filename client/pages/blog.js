          ...
          return (
            <>
                <div className="flex items-center justify-center w-60" key={i}>
                  <div className="justify-center dark:bg-black text-black dark:text-white w-full overflow-y-clip rounded-lg h-fit md:h-60 shadow-xl dark:shadow-none shadow-slate-400">
